...
http_archive(
    ...
    urls = ["https://download.pytorch.org/libtorch/nightly/cu117/libtorch-cxx11-abi-shared-with-deps-2.0.0.dev20230213%2Bcu117.zip"],
)
...
http_archive(
    ...
    strip_prefix = "libtorch",
    urls = ["https://download.pytorch.org/libtorch/nightly/cu117/libtorch-shared-with-deps-2.0.0.dev20230213%2Bcu117.zip"],
)
