...
http_archive(
    ...
    urls = ["https://download.pytorch.org/libtorch/nightly/cu118/libtorch-cxx11-abi-shared-with-deps-2.0.0.dev20230220%2Bcu118.zip"],
)
...
http_archive(
    ...
    strip_prefix = "libtorch",
    urls = ["https://download.pytorch.org/libtorch/nightly/cu118/libtorch-shared-with-deps-2.0.0.dev20230220%2Bcu118.zip"],
)
...
http_archive(
    ...
    urls = [
        "https://developer.nvidia.com/compute/cudnn/secure/8.5.0/local_installers/11.8/cudnn-linux-x86_64-8.5.0.96_cuda11-archive.tar.xz",
    ],
)
