...
class TestRemainderConverter(DispatchTestCase):
    ...
    def test_remainder_dynamic_shape(self, _, min_shape, opt_shape, max_shape, type):
        class remainder(nn.Module):
            def forward(self, lhs_val, rhs_val):
                return torch.ops.aten.remainder.Tensor(lhs_val, rhs_val)
        ...
        self.run_test_with_dynamic_shape(remainder(), input_specs)
        self.run_test_with_dynamic_shape(remainder_scalar(), input_specs)
        self.run_test_with_dynamic_shape(mod_operator(), input_specs)
