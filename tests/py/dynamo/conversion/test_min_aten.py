...
#         class Min(nn.Module):
#             def forward(self, x):
#                 return torch.min(x, dim=dim, keepdim=keep_dims)
#                 # return torch.ops.aten.min.dim(x, dim, keep_dims)
...
#         ]
#     )
#     def test_min_dim_tuple(self, input_shape, dim, keep_dims):
#         class Min(nn.Module):
#             def forward(self, x):
#                 return torch.min(x, dim=dim, keepdim=keep_dims)
...
#         ]
#     )
#     def test_min_dim_tuple_int(self, input_shape, dim, keep_dims, dtype, low, high):
#         class Min(nn.Module):
#             def forward(self, x):
#                 return torch.min(x, dim=dim, keepdim=keep_dims)
