...
TEST_P(AccuracyTests, FP16DLAAccuracyIsClose) {
    ...
    extra_info.device.device_type = trtorch::ExtraInfo::DeviceType::kDLA;
    extra_info.device.gpu_id = 0;
    extra_info.device.dla_core = 1;
    extra_info.device.allow_gpu_fallback = true;
...
INSTANTIATE_TEST_SUITE_P(FP16DLAAccuracyIsCloseSuite,
                         AccuracyTests,
