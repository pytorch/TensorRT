...
grep -qx "torch_tensorrt/include/torch_tensorrt/core/runtime/executorch/ETRTEngine.h" "${tar_entries}"
...
grep -qx "torch_tensorrt/src/torch_tensorrt/core/runtime/executorch/ETRTEngine.cpp" "${tar_entries}"
