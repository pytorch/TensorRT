...
_executorch_minor = ".".join(__executorch_version__.split(".")[:2])
_executorch_next_minor = f"{_executorch_minor.split('.')[0]}.{int(_executorch_minor.split('.')[1]) + 1}"
EXECUTORCH_REQUIREMENT = (
    f"executorch>={__executorch_version__},<{_executorch_next_minor}"
)
