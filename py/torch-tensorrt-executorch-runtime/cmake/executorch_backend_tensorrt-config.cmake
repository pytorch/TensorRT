...
if(CMAKE_VERSION VERSION_LESS 3.19)
  message(FATAL_ERROR
    "executorch_backend_tensorrt needs CMake 3.19 or newer, the same floor ExecuTorch's own package "
...
# lib/cmake/executorch_backend_tensorrt and nowhere else. It used to be found by walking up until a delegate
...
if(TARGET executorch::backend_tensorrt)
  ...
  get_target_property(_executorch_backend_tensorrt_existing_type executorch::backend_tensorrt TYPE)
  if(NOT _executorch_backend_tensorrt_existing_type STREQUAL "SHARED_LIBRARY")
    message(FATAL_ERROR
      "executorch::backend_tensorrt already exists as a ${_executorch_backend_tensorrt_existing_type}, "
  ...
  get_target_property(_executorch_backend_tensorrt_existing_location
    executorch::backend_tensorrt IMPORTED_LOCATION)
  if(NOT _executorch_backend_tensorrt_existing_location STREQUAL "${EXECUTORCH_BACKEND_TENSORRT_BACKEND_LIBRARY}")
    message(FATAL_ERROR
      "executorch::backend_tensorrt already points at "
      "${_executorch_backend_tensorrt_existing_location}, not at the "
      "${EXECUTORCH_BACKEND_TENSORRT_BACKEND_LIBRARY} this package found. Two different delegates cannot "
      "both be used in a single configure: drop one of them.")
  endif()
  message(STATUS "executorch_backend_tensorrt: executorch::backend_tensorrt is already defined, reusing it")
  return()
endif()
...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
  set_property(
    ...
    PROPERTY
      ...
      "LINKER:--push-state,--no-as-needed,${EXECUTORCH_BACKEND_TENSORRT_BACKEND_LIBRARY},--pop-state"
  )
  ...
  if(EXECUTORCH_BACKEND_TENSORRT_EMBED_RUNPATH)
    set_property(
      TARGET executorch::backend_tensorrt
      APPEND
      PROPERTY INTERFACE_LINK_OPTIONS "LINKER:--enable-new-dtags,-rpath,${_executorch_backend_tensorrt_root}/lib"
    )
  else()
    ...
    message(STATUS
      ...
      "${_executorch_backend_tensorrt_root}/lib as a build run path when linking an imported "
