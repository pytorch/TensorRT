...
def _load_module(data: bytes) -> Any:
    ...
    # Verifies TensorRTBackend is registered, and installs this wheel's native
    # module as the process portable runtime, which is what loads the program.
    get_runtime()
    from executorch.extension.pybindings.portable_lib import (
        _load_for_executorch_from_buffer,
    )

    return _load_for_executorch_from_buffer(data)
