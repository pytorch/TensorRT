...
def _get_target_ir(module_type: _ModuleType, ir: str) -> _IRType:
    ...
    ir_targets_dynamo_export = ir == "dynamo_export"
    ...
    elif module_is_fxable and ir_targets_dynamo_export:
        return _IRType.dynamo_export
    else:
        if ir == "default":
...
def compile(
    ...
    **kwargs,
    ...
    elif target_ir == _IRType.dynamo_export:
