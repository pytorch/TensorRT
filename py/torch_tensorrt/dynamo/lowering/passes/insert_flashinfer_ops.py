...
#             out = _bfs(arg, lambda n: _is_dist_lin_op(n, mha_gemms[mha_node]), "all_input_nodes")
#             mha_gemms[mha_node].append(out)
...
#         kv_reshaped_dim = mha_gemms[mha_node][1].meta["val"].shape[-1] #mha_node.args[1].meta["val"]  #

#         mha_info[mha_node] = AttentionInfo(
#             num_heads=q_fake.shape[1],
#             num_kv_heads=kv_reshaped_dim // head_dim,
...
#             mha_node_with_cache.meta["val"] = copy.copy(qkv[0].meta["val"])
