...
# ``tensorrt::no_op_placeholder_for_execute_engine`` is registered unconditionally
# in ``torch_tensorrt.dynamo.runtime._TRTEngine`` so load-time deserialisation works
# under either runtime configuration.
