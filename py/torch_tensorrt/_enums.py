...
class dtype(Enum):
    ...
    def _from(
        ...
        Arguments:
            ...
            use_default (bool): In some cases a catch all type (such as ``torch_tensorrt.dtype.f32``) is sufficent, so instead of throwing an exception, return default value.
    ...
    def to(
        ...
        Arguments:
            t (Union(Type(torch.dtype), Type(tensorrt.DataType), Type(numpy.dtype), Type(dtype))): Data type enum from another library to covert to
            use_default (bool): In some cases a catch all type (such as ``torch.float``) is sufficent, so instead of throwing an exception, return default value.
...
class memory_format(Enum):
    ...
    def to(
        ...
        Arguments:
            t (Union(Type(torch.memory_format), Type(tensorrt.TensorFormat), Type(memory_format))): Memory format type enum from another library to covert to
...
class DeviceType(Enum):
    ...
    def to(
        ...
        Arguments:
            t (Union(Type(tensorrt.DeviceType), Type(DeviceType))): Device type enum from another library to covert to
...
class EngineCapability(Enum):
    ...
    def try_from(
        ...
        Arguments:
            c (Union(tensorrt.EngineCapability, EngineCapability)): Engine capablity enum from another library
    ...
    def to(
        ...
        Arguments:
            t (Union(Type(tensorrt.EngineCapability), Type(EngineCapability))): Engine capability enum from another library to covert to
