...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        type=int,
        help="Length of input sequence to HF model",
    )
    arg_parser.add_argument(
    ...
    for precision in precisions:
        if params["input_sequence_length"] and is_hf:
            inputs = [("Repeat " * params["input_sequence_length"])[:-1]]
        else:
            inputs = parse_inputs(
            ...
            if is_hf:
                ...
                for benchmark_fn in ["generate"]:
                    ...
                    if benchmark_fn == "generate":
                        model_kwargs["min_new_tokens"] = params[
                            "output_sequence_length"
                        ]
                        model_kwargs["max_new_tokens"] = params[
                            "output_sequence_length"
                        ]
